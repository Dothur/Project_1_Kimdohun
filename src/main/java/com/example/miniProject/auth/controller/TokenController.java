package com.example.miniProject.auth.controller;

import com.example.miniProject.auth.entity.CustomUserDetails;
import com.example.miniProject.auth.jwt.JwtTokenUtils;
import com.example.miniProject.auth.jwt.JwtTokenDto;
import com.example.miniProject.auth.jwt.JwtRequestDto;
...
public class TokenController {
    ...
    public JwtTokenDto issueJwt(@RequestBody JwtRequestDto dto) {
        ...
        CustomUserDetails userDetails
                = (CustomUserDetails) manager.loadUserByUsername(dto.getUsername());
